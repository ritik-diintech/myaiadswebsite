...
const OutdoorAdsPage = () => {
  useEffect(() => {
    ...
    if (metaDesc) {
      metaDesc.setAttribute('content', 'Scale your business with high-impact outdoor marketing. From mobile van branding and Look Walkers to transit media, street light kiosks, and pole branding across major cities.');
    }
